...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  final firstPasswordEditingController = new TextEditingController();
  final secondPasswordEditingController = new TextEditingController();
  ...
  final registerButton = Material(
    ...
    child: MaterialButton(
      ...
      onPressed: () {
        signUp(emailEditingController.text, firstPasswordEditingController.text);
      },
      child: Text(
        'Register',
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      SizedBox(
                        height: 150,
                        child: Image.asset('assets/player1.png',
                          fit: BoxFit.contain,
                        ),                                       
                      ),
                      Text(
